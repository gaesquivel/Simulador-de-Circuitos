...
{
    public class ComplexPlainSolver:ACSweepSolverH1
    {
        ...
        /// </summary>
        public Dictionary<Tuple<int, int>, Complex> WfromIndexes { get; protected set; } // i   j  W  
        ...
        public override bool Solve(Circuit cir, BasicAnalysis ana)
        {
            ...
            for (int i = 0; i <= analis.Points; i++)
            {
                ...
                for (int j = 0; j <= analis.Points; j++)
                {
                    ...
                    W = new Complex((sigmamin + j * deltasig), (wi + i * deltaw));
                    ACSweepSolverH1.Calculate(solveinfo, W);
                   ...
                   // Results[i,j] = new Tuple<Complex,Complex>(W, 
